...
/*
* Select only the pairs (obj1, obj2) defined in lst from src  
* src  : volume with the labels of the objects to filter (e.g. synaptic clefts)  
* lbl1 : volume with the obj1 labels  
* lbl2 : volume with the obj2 labels  
* list : path to the file containing the pairs (obj1, obj2)  

* => I1 = intersect(lbl1, lbl2) : intersection with the labels from lbl1  
* => I2 = intersect(lbl2, lbl1) : intersection with the labels from lbl2  
* Res = zeros()  
